// This function generates the fcs look up table.
// ```
...
#[cfg(test)]
mod tests {
    use crate::checksum::INIT_FCS16;
    use crate::checksum::fcs16_part;

    use crate::checksum::GOOD_FCS16;

    fn check_fcs(data: &[u8]) -> bool {
        let trialfcs = fcs16_part(INIT_FCS16, data);
        trialfcs == GOOD_FCS16
    }
